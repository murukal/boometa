...
/** 图的配置项 */
import { useGraphConfig } from './assets'
...
const Boomap = () => {
  ...
  const onLoad: IAppLoad = async (app) => {
    const nodes: NsGraph.INodeConfig[] = [
      { id: 'root1', width: 150, height: 40, renderKey: 'Material', info: { text: 'root1' } },
      { id: 'down1', width: 150, height: 40, renderKey: 'Material', info: { text: 'down1' } },
      { id: 'down2', width: 150, height: 40, renderKey: 'Material', info: { text: 'down2' } },
      { id: 'down3', width: 150, height: 40, renderKey: 'Material', info: { text: 'down3' } }
    ]
    ...
    graph.on('node:click', ({ node }) => {
      ...
      console.log(`${nodeData.id}节点被点击了`)
    })
    graph.on('edge:click', ({ edge }) => {
      edge.toFront()
      const edgeData: NsGraph.IEdgeConfig = edge.getData()
      console.log(`${edgeData.id}连线被点击了`)
    })
  }
